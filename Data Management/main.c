...
void ajouter_avec_fichier(Arbre* arbre);
void ajouter_noeud(Arbre* arbre);
void rechercher(Arbre* arbre);
void modifier_noeud(Arbre* arbre);
void display_noeuds(Arbre* arbre);
void compter(Arbre* arbre);
void supprimer(Arbre* arbre);
Arbre* clear(Arbre* arbre);
...
void ajouter_avec_fichier(Arbre* arbre){
    ...
    else
    {
        ...
        while (!feof(f))
        {
            ...
            inserer_noeud_avec_fichier(arbre, cle, employe);
        }
        fclose(f);
    }
}
